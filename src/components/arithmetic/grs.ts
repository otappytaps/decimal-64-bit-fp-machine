...
export function roundGRS(coeff: string, g: number, r: number, s: number): string {
...
/** Shift a 16-digit coefficient right by n positions with GRS extraction */
...
/** Add two signed decimal magnitudes using BigInt */
...
/** Normalize a coefficient and propagate GRS digits */
export function normalize(
    ...
    if (shift > 0) {
        ...
        return { sign, coeff: newCoeff, exp: exp - shift, g: newG, r: newR, s: newS };
    }
